 ...
 * POST /api/register-customer (Python - Database Operation)
 */
 ...
 * GET /api/get-pending (Python - Database Operation)
 */
 ...
 * POST /api/upload-document (Python - Background Task)
 */
export const uploadDocument = async (
  ...
  if (APP_CONFIG.useMockMode) {
    ...
    try {
      // CHANGED: Back to Python endpoint. 
      // Python will now handle the "Human Delay" in the background.
